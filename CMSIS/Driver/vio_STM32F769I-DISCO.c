...
static const pinCfg_t outputCfg[] = {
  { vioLED0, GPIO_PIN_ID_PORTJ(13), GPIO_PULL_NONE, VIO_ACTIVE_HIGH, 0U },
  { vioLED1, GPIO_PIN_ID_PORTJ(5),  GPIO_PULL_NONE, VIO_ACTIVE_HIGH, 0U }
};
#endif
...
static const pinCfg_t inputCfg[] = {
  { vioBUTTON0, GPIO_PIN_ID_PORTA(0), GPIO_PULL_NONE, VIO_ACTIVE_HIGH, 0U }
};
#endif
