...
| vioLED0       | vioSignalOut.0 | LED red     (LD1)    | PJ5
| vioLED1       | vioSignalOut.1 | LED green   (LD2)    | PJ13
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTJ(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTJ(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
