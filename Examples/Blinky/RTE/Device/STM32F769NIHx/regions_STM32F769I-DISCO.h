...
// <i> Board Support Pack (BSP):   Keil::STM32F769I-DISCO_BSP@1.0.0
...
//   <o> Base address <0x0-0xFFFFFFFF:8>
//   <i> Defines base address of memory region. Default: 0x20020000
//   <i> Contains uninitialized RAM, Stack, and Heap
#define __RAM0_BASE 0x20020000
//   <o> Region size [bytes] <0x0-0xFFFFFFFF:8>
//   <i> Defines size of memory region. Default: 0x00060000
#define __RAM0_SIZE 0x00060000
// </h>
...
// <i> rx ROM:   ITCM_Flash from DFP:  BASE: 0x00200000  SIZE: 0x00200000
// <i> rwx RAM:  DTCM from DFP:        BASE: 0x20000000  SIZE: 0x00020000
